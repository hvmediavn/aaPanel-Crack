#! /bin/bash
# By Aaron
# https://github.com/hvmediavn/aaPanel-Crack
...
wget -O "/root/LinuxPanel_EN-6.8.23.zip" "https://ghproxy.com/https://github.com/hvmediavn/aapanel-crack/releases/download/1.0/LinuxPanel_EN-6.8.23.zip"
red "Download complete, downgrading."
unzip LinuxPanel_EN-6.8.23.zip
cd /root/panel
wget -O "/root/panel/downgrade.sh" "https://ghproxy.com/https://raw.githubusercontent.com/hvmediavn/aapanel-crack/main/script/downgrade.sh" 
...
wget -O "/root/LinuxPanel-7.7.0.zip" "https://ghproxy.com/https://github.com/hvmediavn/aapanel-crack/releases/download/1.3/LinuxPanel-7.7.0.zip"
...
wget https://ghproxy.com/https://raw.githubusercontent.com/hvmediavn/aaPanel-Crack/main/resource/repair.json
chattr +i /www/server/panel/data/repair.json
...
wget -O /root/chinese.zip https://ghproxy.com/https://github.com/hvmediavn/aaPanel-Crack/releases/download/1.2/aapanel_chinese-6.8.21.zip
...
function start_menu(){
    ...
    purple " https://github.com/hvmediavn/aaPanel-Crack"
    yellow " ————————————————————————————————————————————————"
